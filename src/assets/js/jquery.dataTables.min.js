...
(function(h) {
    ...
    function K(a, b, c, d) {
        ...
        else if (b = n.ext, b = b.sErrMode || b.errMode, a && t(a, null, "error", [a, d, c]), "alert" == b) console.log(c);
    ...
    var Mb = n.ext.pager;
    h.extend(Mb, {
        simple: function() { return ["prev", "next"] },
        full: function() { return ["first", "prev", "next", "last"] },
        numbers: function(a, b) { return [ja(a, b)] },
        simple_numbers: function(a, b) { return ["prev", ja(a, b), "next"] },
        full_numbers: function(a,
            b) { return ["first", "prev", ja(a, b), "next", "last"] },
